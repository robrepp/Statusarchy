...
class Mysql
{
	...
	public function testConn()
	{
		...
		$test = @mysql_connect($this->host, $this->username, $this->password, true);
	...
	public function connect()
	{
		...
		if($this->checkConnection(false))
			return true;
		$this->sqlObject = mysql_connect($this->host, $this->username, $this->password, true);
	...
	public function disconnect()
	{
		...
		if($this->checkConnection(false))
			return mysql_close($this->sqlObject);
		return true;
	}
	// QUERY FUNCTIONS
	...
	// Get the query amount, useful for site stats at the bottom of a webpage
